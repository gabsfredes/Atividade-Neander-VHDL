...
add wave -noupdate -radix hexadecimal /tb_neander/arquivo/neander_inst/decoder
add wave -noupdate -radix hexadecimal /tb_neander/arquivo/neander_inst/memoria
add wave -noupdate -radix hexadecimal /tb_neander/arquivo/neander_inst/MUX
add wave -noupdate -radix hexadecimal /tb_neander/arquivo/neander_inst/SOMA
add wave -noupdate -radix hexadecimal /tb_neander/arquivo/neander_inst/SUB
add wave -noupdate -radix hexadecimal /tb_neander/arquivo/neander_inst/MULT
...
add wave -noupdate -radix hexadecimal /tb_neander/arquivo/neander_inst/ACC
...
WaveRestoreCursors {{Cursor 1} {46618 ps} 0}
